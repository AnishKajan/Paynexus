  ...
  return (
    <div
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.boxShadow = "0 4px 32px rgba(110,20,212,0.1)";
      }}
      onMouseLeave={(e) => {
        e.currentTarget.style.borderColor = "rgba(110,20,212,0.12)";
    ...
    >
      ...
      <div className="mt-1 text-xs font-mono" style={{ color: isPositive ? "#22c55e" : "#ef4444" }}>
...
function ComplianceGauge({ label, value, color }: { label: string; value: number; color: string }) {
  return (
    <div className="flex items-center gap-3">
      <span className="text-xs font-mono w-20 shrink-0" style={{ color: "rgba(255,255,255,0.4)" }}>
        {label}
      </span>
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    // Load user email (for UserProfileMenu)
    (async () => {
      ...
      <div className="flex">
        ...
        >
          ...
          {[
            ...
            <HulyButton
              key={item.label}
              className={`flex items-center gap-3 px-3 py-2.5 rounded-full mb-1 w-full ${
        ...
        <main className="flex-1 p-6 md:p-10 overflow-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex items-center gap-3">
              <span
                className="px-3 py-1.5 rounded-full text-[10px] font-mono font-semibold uppercase tracking-wider"
                ...
                {TRANSACTIONS.slice(0, 6).map((tx) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs font-mono" style={{ color: statusColor[tx.status] || "#fff" }}>
                        {tx.status}
                      </p>
                    </div>
                  </button>
              ...
              >
                <div className="flex items-center justify-between mb-5">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="px-2 py-1 rounded text-[10px] font-mono font-bold uppercase" style={{ background: "rgba(34,197,94,0.1)", color: "#22c55e" }}>
                      LOW
                    </span>
                    <span className="text-xs group-hover:text-purple-400 transition-colors" style={{ color: "rgba(255,255,255,0.2)" }}>
                      →
                    </span>
                  </div>
                </div>
                ...
                <div className="mt-6 p-3 rounded-lg" style={{ background: "rgba(110,20,212,0.06)", border: "1px solid rgba(110,20,212,0.1)" }}>
                  <p className="text-[10px] font-mono" style={{ color: "rgba(255,255,255,0.4)" }}>
                    <span style={{ color: "#a855f7" }}>GraphSAGE v2.1</span> · 3 layers · AUC 0.94
                    <br />
                ...
                <div className="mt-6">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <HulyButton className="px-3 py-2 rounded-full text-xs font-mono" style={{ border: "1px solid rgba(55, 65, 81, 0.5)", color: "rgba(255,255,255,0.4)" }}>
                      Copy
                    </HulyButton>
                  </div>
                </div>

                <p className="mt-4 text-[10px] font-mono text-purple-400/60 group-hover:text-purple-400 transition-colors">
