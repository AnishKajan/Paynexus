    ...
    return (
        <div>
            ...
            >
                ...
                >
                    <div className="relative mt-0.5 flex-shrink-0">
                        ...
                        />
                        <div
                            className="w-4 h-4 rounded border transition-all duration-200 flex items-center justify-center peer-checked:border-purple-500 peer-checked:bg-purple-600/20"
                            style={{
                                borderColor: agreedToTerms
                                    ? "#6E14D4"
                                    : "rgba(148,163,184,0.3)",
                                background: agreedToTerms
                                    ? "rgba(110,20,212,0.15)"
                        ...
                        >
                            {agreedToTerms && (
                                <svg
                                    ...
                                    viewBox="0 0 10 10"
                                    fill="none"
                                    style={{ animation: "fadeUpIn 150ms ease-out" }}
                                >
                                    <path
                                        d="M2 5L4 7L8 3"
                                        stroke="#6E14D4"
                ...
                <button
                    ...
                    disabled={loading}
                    className="w-full mt-4 py-3 rounded-lg text-sm font-semibold tracking-wide transition-all duration-200 flex items-center justify-center gap-2"
                    style={{
                ...
                <button
                    ...
                    className="w-full py-3 rounded-lg text-sm font-medium tracking-wide transition-all duration-200 flex items-center justify-center gap-3"
                    style={{
            ...
            >
                <button
                    onClick={handleBack}
                    className="flex items-center gap-1 text-xs font-mono mb-5 transition-colors duration-200"
                ...
                <p
                    className="text-sm font-mono font-semibold mb-6"
                    style={{ color: "#6E14D4" }}
                >
                    {email}
                </p>
                ...
                <div className="mt-4 text-center">
                    {resendCooldown > 0 ? (
                        ...
                        <button
                            ...
                            onMouseEnter={(e) => {
                                e.currentTarget.style.color = "#6E14D4";
                            }}
                            onMouseLeave={(e) => {
                                e.currentTarget.style.color = "rgba(110,20,212,0.7)";
                            }}
                        >
                            Resend code
                        </button>
            ...
            {error && (
                <p
                    className="mt-4 text-xs font-mono text-center px-2"
                    style={{
                        color: "#ef4444",
